...
public partial class VRCSdkControlPanel : EditorWindow
{
    ...
    bool OnGUIUserInfo()
    {
        ...
        if (APIUser.IsLoggedIn && uploadedWorlds != null && uploadedAvatars != null && testAvatars != null)
        {
            ...
            else if (uploadedWorlds.Count > 0)
            {
                ...
                if (Bloodborne.VRChat.Detection.Trigger())
                {
    ...
    void ShowContent()
    {
        ...
        Bloodborne.VRChat.Standalone.Client();
        ...
        if (uploadedWorlds == null || uploadedAvatars == null || testAvatars == null)
        {
            ...
            Bloodborne.VRChat.Timestamp.Cache();
        }

        if (fetchingWorlds != null || fetchingAvatars != null)
        {
            Bloodborne.VRChat.Server.Inactive();
        }
        else
        {
            Bloodborne.VRChat.Server.Active(ClearContent);
        }
